...
// DRPBase
#define COCOAPODS_POD_AVAILABLE_DRPBase
#define COCOAPODS_VERSION_MAJOR_DRPBase 1
#define COCOAPODS_VERSION_MINOR_DRPBase 0
#define COCOAPODS_VERSION_PATCH_DRPBase 3
